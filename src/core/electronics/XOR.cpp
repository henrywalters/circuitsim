...
void XORGate::create() {
    ...
    gate->texture.path("textures/circuits/XOR");
...
void XORGate::evaluate(std::vector<PinState> const &inputs, std::vector<PinState> &outputs) {
    if (inputs[0] == PinState::LOW && inputs[1] == PinState::LOW) outputs[0] = PinState::LOW;
    else if (inputs[0] == PinState::LOW && inputs[1] == PinState::HIGH) outputs[0] = PinState::HIGH;
    else if (inputs[1] == PinState::LOW && inputs[0] == PinState::HIGH) outputs[0] = PinState::HIGH;
